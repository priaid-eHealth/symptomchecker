...
export class AppComponent {
  ...
  languages: langObject[] = [{value:"en-gb",name:"en-gb"},{value:"de-ch",name:"de-ch"},{value:"fr-fr",name:"fr-fr"},{value:"es-es",name:"es-es"},{value:"ru-ru",name:"ru-ru"},{value:"tr-tr",name:"tr-tr"},{value:"sk-sk",name:"sk-sk"}]
  token: string;
